                        ...
                        <form id="form" name="form" action="{{ $actionForm }}" method="post" autocomplete="off">
                            ...
                            <div class="grid grid-cols-3">
                                <div class="mb-4 col-span-3">
                                    ...
                                    <input type="text" id="descricao" name="descricao" value="@empty($pagamento)@else{{$pagamento->descricao}}@endempty" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Descrição do tipo de pagamento Ex: Credito, boleto, pix">
                                </div>
                                <div class="mb-4 col-span-1 col-start-1">
                                    ...
                                    <input type="number" id="parcelas" name="parcelas" value="@empty($pagamento)@else{{$pagamento->limiteParcelas}}@endempty" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
