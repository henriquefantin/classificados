            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="" method="post">
                        @csrf
                        <div class="mb-4">
                            <label for="descricao" class="form-label">Tipo do Anuncio</label>
                            <input type="text" id="descricao" name="descricao" class="" placeholder="Descrição do tipo do anuncio Ex: Carro, Moto, Agricolas">
                        </div>
